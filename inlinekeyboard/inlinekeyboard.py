...
from inlinekeyboard.inlinekeyboardtypes import *
...
class InlineKeyboard(object):
    ...
    def __create_inline_keyboard(self, keyb_type, lang, data, history):
        ...
        elif keyb_type == choose_place_keyboard:

            return self.__get_choose_place_keyboard(inline_keyboard_types[keyb_type][lang])
    ...
    @staticmethod
    def __get_choose_place_keyboard(buttons):
